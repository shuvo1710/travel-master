...
const Header = () => {
  ...
  const { user, logOutUser } = useContext(UseContext);
        ...
        <div className="relative flex items-center justify-between">
          ...
          >
            <span className="ml-2 text-xl font-bold tracking-wide text-gray-500 uppercase">
              <span className="text-orange-500">Travel</span> Master
            </span>
          </Link>
            ...
            {user?.uid ? (
              ...
              <>
                ...
                <li>
                  <Link
                    to="/login"
                    className="inline-flex items-center justify-center font-semibold h-12 px-6  tracking-wide text-white bg-orange-400 transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-orange-600 focus:shadow-outline focus:outline-none"
                    aria-label="Sign in"
                    title="Sign in"
                  >
                    Log in
